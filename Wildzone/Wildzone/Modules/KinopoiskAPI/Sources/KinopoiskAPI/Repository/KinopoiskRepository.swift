...
public class KinopoiskRepositoryImpl: KinopoiskRepository {
    
    public init() {}
    
    public func getPossibleValues(field: String, completion: @escaping (_ data: [PossibleValueModel]?, _ error: Error?) -> Void) {
        KinopoiskAPI.getPossibleValuesByField(field: field, completion: completion)
    }

    public func searchFilms(query: String, page: Int = 1, limit: Int = 10, completion: @escaping (_ data: MovieResponseModel?, _ error: Error?) -> Void) {
        KinopoiskAPI.searchFilmsGet(query: query, page: page, limit: limit, completion: completion)
    }

    public func getPosters(movieId: [String], type: [String], language: [String], height: [String], width: [String], updatedAt: [String], createdAt: [String], page: Int = 1, limit: Int = 10, completion: @escaping (_ data: MovieResponseModel?, _ error: Error?) -> Void) {
